...
function heuristicLinkedInParse(rawText: string, linkedinUrl?: string): ExtractedLinkedInProfile {
  ...
  return {
    ...
    skills: foundSkills.length > 0 ? foundSkills : [
      ...
      { name: "TypeScript", category: SkillCategory.FRONTEND, proficiency: SkillLevel.ADVANCED },
      { name: "Node.js", category: SkillCategory.BACKEND, proficiency: SkillLevel.INTERMEDIATE },
    ],
    education: [],
  };
}
